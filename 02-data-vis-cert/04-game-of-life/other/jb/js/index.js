...
function repeat_anim(queue) {
    ...
    return {
        ...
        signal_performance_stats: function signal_performance_stats(msg) {
            if (this.call_back instanceof Function) {
                this.call_back(msg);
            }
        },
        start_if_stopped: function start_if_stopped() {
...
var life_game = {
    ...
    register_signal_handler: function register_signal_handler(func) {
        this.call_back = func;
    ...
    do_next_generation: function do_next_generation(paused) {
        if (paused) {
    ...
    get_number_snail_items: function get_number_snail_items() {
        var nr_itms = 0;
    ...
    get_snail_length: function get_snail_length() {
        return this.snail_trail.length - this.snail_trail.length % 3;
    },
    snail_cursor_next: function snail_cursor_next() {
    ...
    draw_magnify: function draw_magnify(x, y) {
        var srcctx, ctx, rc;
    ...
    init: function init(canvas_elt, canvas_elt_magnify) {
    ...
    clear_screen: function clear_screen() {
        var i, j;
    ...
    seed_random_20pct: function seed_random_20pct() {
        this.seed_random_percentage(0.2);
    },
    seed_random_60pct: function seed_random_60pct() {
        this.seed_random_percentage(0.6);
    },
    seed_random_percentage: function seed_random_percentage(pct) {
    ...
    seed_colony: function seed_colony(count) {},
    seed_space_invaders: function seed_space_invaders() {},
    seed_game_of_life: function seed_game_of_life() {
        var max_num = this.blk_width * this.blk_height;
        this.frame_current.fill(0, 0);
        this.frame_next.fill(0, 0);
        this.frame_work_todo_index.fill(0, 0);
    ...
    add_cell: function add_cell(x, y) {
    ...
    mouse_mark: function mouse_mark(x, y, btn_press) {
        ...
        if (Number.isInteger(x) && Number.isInteger(y)) {
            if (this.snail_trail_wm == snail_length) {
                //no more space, round robin
    ...
    color_index_to_color: function color_index_to_color(_color) {
        switch (_color) {
            case 0:
    ...
    get_color_from_frame: function get_color_from_frame(x, y) {
    ...
    restore_color: function restore_color(x, y) {
        var ctx = this.canvas_elt.getContext("2d");
        if (Number.isInteger(x) && Number.isInteger(y)) {
            var rc = this.get_color_from_frame(x, y);
            if (rc.color == undefined) {
    ...
    plot_red_marker: function plot_red_marker(x, y) {
        var ctx = this.canvas_elt.getContext("2d");
        if (Number.isInteger(x) && Number.isInteger(y)) {
            var rc = this.get_color_from_frame(x, y);
            ctx.fillStyle = "red";
    ...
    plot_index_buffer: function plot_index_buffer() {
    ...
    game_of_life_rules: function game_of_life_rules(cell, coords) {
        var nr = 0;
        var rc = 0;
        var current_state;
    ...
    _get_surrounding_cells: function _get_surrounding_cells(cell, coords) {
        var cell_c;
    ...
    find_in_idx: function find_in_idx(coord) {
    ...
    next_frame_and_swap: function next_frame_and_swap() {
        var i, j;
        var coords;
        var cells;
        var color;
...
var util = {
    add_classes: function add_classes(elt, classnames) {
        var i;
    ...
    remove_classes: function remove_classes(elt, classnames) {
        var i;
        if (typeof elt === "string") {
            elt = document.getElementById(elt);
        }
    ...
    contains_any_class: function contains_any_class(elt, classnames) {
        var i;
        if (typeof elt === "string") {
            elt = document.getElementById(elt);
        }
    ...
    throttle: function throttle(type, name, obj) {
        ...
        var func = function func(original_evt) {
            if (running) {
                return;
            }
            running = true;
    ...
    throttle_fun: function throttle_fun(func) {
        'use strict';
...
var FlapoutFooter = React.createClass({
    displayName: "FlapoutFooter",
    _ll: function _ll(str) {
        console.log(str + ":[" + this.constructor.displayName + "]");
    },
    _msg_handler: function _msg_handler(msg) {
        throw new Error('[App] received an unknown message:' + msg);
    },
    _select_radio: function _select_radio(evt) {
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        null,
                        React.createElement("input", { type: "radio", id: this.state.radio_01, value: "seed_20pct", checked: is_seed_20pct, name: "selector", onChange: this._select_radio }),
                        React.createElement(
                            "label",
                            { htmlFor: this.state.radio_01 },
                            React.createElement(
                                "span",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        null,
                        React.createElement("input", { type: "radio", id: this.state.radio_02, value: "seed_60pct", name: "selector", checked: is_seed_60pct, onChange: this._select_radio }),
                        React.createElement(
                            "label",
                            { htmlFor: this.state.radio_02 },
                            React.createElement(
                                "span",
                                { className: "radio-text" },
                                "Random seeding 60%"
...
var FlapoutMain = React.createClass({
    displayName: "FlapoutMain",
    _ll: function _ll(str) {
        console.log(str + ":[" + this.constructor.displayName + "]");
    },
    _toggle_play_pause: function _toggle_play_pause(evt) {
    ...
    _pause_and_clear: function _pause_and_clear(evt) {
        life_game.animation.pause_on();
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("input", { id: this.state.input_id, type: "checkbox", checked: is_paused, onChange: this._toggle_play_pause }),
                React.createElement(
                    "label",
                    { htmlFor: this.state.input_id, className: "play-and-stop" },
                    React.createElement(
                        "div",
                        null,
                        React.createElement(
                            "a",
                            { ref: "svg-pause", className: "pause" },
                            React.createElement(
                                "div",
                                null,
                                React.createElement(
                                    "svg",
                                    { version: "1.1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 58 58" },
                                    React.createElement("circle", { className: "shaded", cx: "29", cy: "29", r: "29" }),
                                    React.createElement("rect", { className: "empress", x: "32.66", y: "16", width: "8", height: "26" }),
                                    React.createElement("rect", { className: "empress", x: "19.33", y: "16", width: "8", height: "26" })
                                )
                            )
                        ),
                        React.createElement(
                            "a",
                            { ref: "svg-play", className: "play" },
                            React.createElement(
                                "div",
                                null,
                                React.createElement(
                                    ...
                                    React.createElement(
                                        "g",
                                        null,
                                        React.createElement("polygon", { className: "empress", points: "44,29 22,44 22,29.273 22,14" }),
                                        React.createElement("path", { className: "empress", d: "M22,45c-0.16,0-0.321-0.038-0.467-0.116C21.205,44.711,21,44.371,21,44V14\nc0-0.371,0.205-0.711,0.533-0.884c0.328-0.174,0.724-0.15,1.031,0.058l22,15C44.836,28.36,45,28.669,45,29s-0.164,0.64-0.437,0.826\nl-22,15C22.394,44.941,22.197,45,22,45z M23,15.893v26.215L42.225,29L23,15.893z" })
                                    )
                                )
                            )
                        )
                ...
                React.createElement(
                    "a",
                    { ref: "svg-stop", className: "stop", onClick: this._pause_and_clear },
                    React.createElement(
                        "div",
                        null,
                        React.createElement(
                            ...
                            React.createElement(
                                "g",
                                null,
                                React.createElement("rect", { className: "empress", x: "16", y: "16", width: "26", height: "26" }),
                                React.createElement("path", { className: "empress", d: "M43,43H15V15h28V43z M17,41h24V17H17V41z" })
                            )
                        )
                    )
                )
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        { ref: "generation", className: "txt-nr" },
                        generations
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        { ref: "grid-width", className: "txt-nr" },
                        grid_width
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        { ref: "grid-height", className: "txt-nr" },
                        grid_height
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        { ref: "cells-eval", className: "txt-nr" },
                        cells_processed
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        "span",
                        { ref: "cells-drawn", className: "txt-nr" },
                        cells_drawn
                    )
                )
            )
...
var FlapoutHeader = React.createClass({
    displayName: "FlapoutHeader",
    _ll: function _ll(str) {
        console.log(str + ":[" + this.constructor.displayName + "]");
    },
    _open: function _open(evt) {
        var signal = this.props.signal_parent;
        if (signal) {
            signal({ tag: "open" });
        }
    },
    _close: function _close(evt) {
        var signal = this.props.signal_parent;
        if (signal) {
            signal({ tag: "close" });
        }
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                "div",
                { ref: "btn-open", className: "open", onClick: this._open },
                React.createElement(
                    "svg",
                    { version: "1.1", viewBox: "0 0 49.656 49.656" },
                    React.createElement(
                        "g",
                        null,
                        React.createElement("polygon", { points: "14.535,48.242 11.707,45.414 32.292,24.828 11.707,4.242 14.535,1.414 37.949,24.828 \t" }),
                        React.createElement("path", { d: "M14.535,49.656l-4.242-4.242l20.585-20.586L10.293,4.242L14.535,0l24.829,24.828L14.535,49.656z M13.121,45.414l1.414,1.414l22-22l-22-22l-1.414,1.414l20.585,20.586L13.121,45.414z" })
                    )
                )
            ),
            React.createElement(
                ...
                React.createElement(
                    "span",
                    { key: "fps", ref: "fps-number" },
                    this.props.fps
                )
            ),
            React.createElement(
                "div",
                { ref: "btn-close", className: "close", onClick: this._close },
                React.createElement(
                    "svg",
                    { version: "1.1", viewBox: "0 0 42 42" },
                    React.createElement("line", { className: "lcl", x1: "21", y1: "0", x2: "21", y2: "42" }),
                    React.createElement("line", { className: "lcl", x1: "42", y1: "21", x2: "0", y2: "21" })
                )
            )
        );
    }
...
var Flapout = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            "div",
            { ref: "flap-window", className: class_names.join(' ') },
            React.createElement(FlapoutHeader, { ref: "flapoutHeader", fps: fps, signal_parent: this._msg_handler }),
            " ",
            React.createElement(FlapoutMain, { signal_parent: this._msg_handler, ref: "flapoutMain", generations: generations, cells_processed: nr_processed, cells_drawn: nr_drawn }),
            React.createElement(FlapoutFooter, { ref: "flapoutFooter" })
        );
    }
});
var Canvas = React.createClass({
    ...
    _resize_canvas: function _resize_canvas() {
    ...
    _schedule_resize: function _schedule_resize(evt) {
    ...
    _on_mouse_over_mouse_down: function _on_mouse_over_mouse_down(evt) {
    ...
    render: function render() {
        ...
        return React.createElement(
            "div",
            { key: "surface_000", ref: "surface", className: "inner-canvas" },
            React.createElement(
                "canvas",
                { key: "canvas-333", ref: "main-canvas", className: "main-canvas", width: "0px", height: "0px", onMouseMove: this._on_mouse_over_mouse_down, onMouseDown: this._on_mouse_over_mouse_down },
                "Canvas!"
            ),
            React.createElement("canvas", { key: "canvas-666", ref: "magnify", className: "magnify", width: "0px", height: "0px" })
        );
    }
});
var App = React.createClass({
    ...
    render: function render() {
        this._ll("render");
        return React.createElement(Canvas, { monitor_dialog: this.props.monitor_dialog });
    }
});
window.onload = function () {
    var flapout = ReactDOM.render(React.createElement(Flapout, null), document.getElementById("flapout-container"));
    var canvasApp = ReactDOM.render(React.createElement(App, { monitor_dialog: flapout }), document.getElementById("container-anchor"));
