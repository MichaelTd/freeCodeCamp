    ...
    return React.createElement('div', { className: 'container' },
      React.createElement('div', { className: 'row' },
        React.createElement('div', { className: 'col-xs-6' },
          this.state.defaultText !== null ? React.createElement('textarea', { className: 'editor', onChange: this.changeText.bind(this), defaultValue: this.state.defaultText }) : React.createElement('p', null, 'loading...')
        ),
