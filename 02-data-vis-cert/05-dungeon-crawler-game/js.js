...
var CONFIGS = {
  ...
  healthBase: 20,
  weapons: [{ name: 'Unbreakable Chopstick', damage: 0 }, { name: 'Millitary Dagger', damage: 12 }, { name: 'Ninja Katana', damage: 16 }, { name: 'Ninja Katana 2', damage: 22 }, { name: 'Jedi Lightsaber', damage: 30 }, { name: '==|[[{{Excaliber}}]]>', damage: 40 }],
  dungeonDisplay: {
    width: 100,
    height: 100
  },
