            ...
            render: function render() {
                return React.createElement("span",null,
                    React.createElement("div",{ className: "panel panel-primary" },
                        React.createElement("div",{ className: "panel-heading primary", type: "button" },
                            React.createElement("h4",{ className: "panel-title" },
                                React.createElement("a",{ "aria-expanded": "false", className: "cllps-toggler collapsed", "data-toggle": "collapse", "data-parent": "#accordion", href: "#collapse-add" },"Add New Recipe")
                            )
                        ),
                        React.createElement("div",{ "aria-expanded": "false", id: "collapse-add", className: "panel-collapse collapse" },
                            React.createElement("div",{ className: "panel-body" },
                                React.createElement("form",{ role: "form", action: "#", className: "form-vertical" },
                                    React.createElement("fieldset",null,
                                        ...
                                        React.createElement("div",{ className: "btn-group btn-group-justified" },
                                            React.createElement("a",{ href: "#", className: "btn btn-success", id: "add-recipe" },"Add Recipe")
                                        )
                                    )
                                )
                            )
        ...
        var Panel = React.createClass({
            ...
            render: function render() {
                for (var i = 0; i < JSON.parse(localStorage.recipeBook).length; i++) {
                    ...
                    markup.push(React.createElement("div",{ className: "panel panel-default" },
                        React.createElement("div",{ className: "panel-heading", type: "button" },
                            React.createElement("h4",{ className: "panel-title" },
                                React.createElement("a",{ "aria-expanded": "false", className: "cllps-toggler collapsed", "data-toggle": "collapse", "data-parent": "#accordion", href: collapseHREF }, Name)
                            )
                        ),
                        React.createElement("div",{ "aria-expanded": "false", id: collapseId, className: "panel-collapse collapse" },
                            React.createElement("div",{ className: "panel-body" },
                                React.createElement("span", { id: IngrContainerId }),
                                React.createElement("div",{ className: "btn-group btn-group-justified" },
                                    React.createElement("a",{ href: collapseEditHREF, "data-toggle": "collapse", className: "btn btn-warning edit-rec", id: editRecipeId }, "Edit Recipe"),
                                    React.createElement("a",{ href: "#", className: "btn btn-danger del-rec", id: deleteRecipeId }, "Delete Recipe")
                                ),
                                React.createElement("div",{ "aria-expanded": "false", id: collapseEditId, className: "panel-collapse collapse" },
                                    React.createElement("div", { className: "panel-body" },
                                        React.createElement("form",{ role: "form", action: "#", className: "form-vertical" },
                                            React.createElement("fieldset", null,
                                                React.createElement("div", { "class": "form-group" },
                                                ...
                                                React.createElement("div", { className: "btn-group btn-group-justified" },
                                                    React.createElement("a", { href: "#", className: "btn btn-success upd-rec", id: updateRecipe },"Update Values")
                                                )
                                            )
                                        )
                                    )
                ...
                return React.createElement("div",{ className: "panel-group", id: "accordion" },markup);
            }
        });

        ReactDOM.render(React.createElement(PanelsContainer, null), document.getElementById('app'));
            ...
            var Ingredients = React.createClass({
                ...
                render: function render() {
                    ...
                    for (var k = 0; k < JSON.parse(localStorage.recipeBook)[i].ingredients.length; k++) {
                        ...
                        ingrMarkup.push(React.createElement("li", { className: "list-group-item" }, CurIngr));
                    }
                    return React.createElement("ul", { className: "list-group" }, ingrMarkup);
                }
            });
